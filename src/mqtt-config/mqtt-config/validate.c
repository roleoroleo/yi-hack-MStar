...
char *config_params[PARAM_NUM][PARAM_OPTIONS] = {
    ...
    { "system", "ONVIF_AUDIO_BC", "enum", "NONE", "G711", "AAC" , "", "", "" },
    { "system", "ONVIF_ENABLE_MEDIA2", "bool", "", "", "" , "", "", "" },
    { "system", "ONVIF_FAULT_IF_UNKNOWN", "bool", "", "", "" , "", "", "" },
    ...
    { "system", "EVENTS_TIME", "enum", "autodetect", "local", "gmt" , "", "", "" },
    ...
    { "system", "STATIC_IP", "string", "", "", "" , "", "", "" },
    { "system", "STATIC_MASK", "string", "", "", "" , "", "", "" },
    { "system", "STATIC_GW", "string", "", "", "" , "", "", "" },
    { "system", "STATIC_DNS1", "string", "", "", "" , "", "", "" },
    { "system", "STATIC_DNS2", "string", "", "", "" , "", "", "" },
